...
class JourneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journey" do
    assert_difference('Journey.count') do
      post journeys_url, params: { journey: { arrival: @journey.arrival, departure: @journey.departure, description: @journey.description, from_id: @journey.from_id, price: @journey.price, to_id: @journey.to_id } }
    end
  ...
  test "should update journey" do
    patch journey_url(@journey), params: { journey: { arrival: @journey.arrival, departure: @journey.departure, description: @journey.description, from_id: @journey.from_id, price: @journey.price, to_id: @journey.to_id } }
