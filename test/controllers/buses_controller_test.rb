...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post buses_url, params: { bus: { description: @bus.description, transporter_id: @bus.transporter_id } }
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { description: @bus.description, transporter_id: @bus.transporter_id } }
