...
class StopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post stops_url, params: { stop: { arrival: @stop.arrival, city_id: @stop.city_id, journey_id: @stop.journey_id, price: @stop.price } }
    end
  ...
  test "should update stop" do
    patch stop_url(@stop), params: { stop: { arrival: @stop.arrival, city_id: @stop.city_id, journey_id: @stop.journey_id, price: @stop.price } }
