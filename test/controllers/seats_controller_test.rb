...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { journey_id: @seat.journey_id, seat_number: @seat.seat_number } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { journey_id: @seat.journey_id, seat_number: @seat.seat_number } }
